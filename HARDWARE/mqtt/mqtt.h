...
#if 0
#define SERVERIP "100.66.40.94" // 服务器IP
#define SERVERPORT 1883         // 服务器端口
#else
#define SERVERIP "bemfa.com" // 服务器IP
#define SERVERPORT 9501      // 服务器端口
#endif
#define PRODUCTID "iot_home"                        // 产品ID
#define PRODUCTID_LEN strlen(PRODUCTID)             // 产品ID长度
#define DEVICEID "af5eabd51e7b4897b3830b8651c32b05" // 设备ID
#define DEVICEID_LEN strlen(DEVICEID)               // 设备ID长度
#define AUTHENTICATION "iot_home"                   // 鉴权信息
#define AUTHENTICATION_LEN strlen(AUTHENTICATION)   // 鉴权信息长度
/**
 * S前缀表示要订阅的主题，P前缀表示要发布的主题
 *  +/set表示向所有设备推送消息，+/up表示只更新云端数据，不进行推送
 */
#define S_TOPIC_LAMP "LAMP002"
#define S_TOPIC_DHT  "DHTCONTROL"
#define P_TOPIC_DHT "DHT004/set"
#define P_TOPIC_LAMP "LAMPMONTIOR/up"
// #define  Data_TOPIC_NAME      "LAMPS"
// #define  DHT11_DATA           "DHT004"
